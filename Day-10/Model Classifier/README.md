...
|----|-------------------------------|----------------------|---------------|----------------|
|A   |Multilingual email triage      |Customer Service      |Text Generation|GPT-4o          |
|B   |Regulatory update review       |Compliance            |Multimodal     |GPT-4o Vision   |
|C   |Fraud alert narratives         |Fraud Detection       |Text Generation|Gemini 1.5 Flash|
